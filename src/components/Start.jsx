  ...
  return (
    <div className="flex justify-center flex-col gap-10 h-screen">
        ...
        <div className="flex justify-center items-center flex-col">
          ...
          className="bg-white text-lg w-[50%] lg:w-[25%] border-2 border-b-gray-700 px-3 py-2 text-center rounded-md mb-3 focus-within:outline-0" placeholder="Enter Your Name" />
          <button
          onClick={() => {
